...
for i in range(len(times)):
    ...
    rhd_choice = rhanalyze.rhout('/Users/coletamburri/Desktop/RH_Versions_and_Tools/RH_Oct_2023/RH/rhf1d_fchroma_43s_mod30_20broadc_2ndadjust_5vt_H20/run')
    ...
    #filename = base2+'rhf1d_11Aug_Cclass_PBd_23s_mu0.npz'
    ...
    LINENO = 22 ### ['0=Ca IIH';'22-H-epsilon';'19-H-beta']
    DWING  = 2
    DLAMB  = 2.0
