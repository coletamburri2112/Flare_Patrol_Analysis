...
for i in range(len(times)):
    ...
    rhd_choice = rhanalyze.rhout('/Users/coletamburri/Desktop/RH_Versions_and_Tools/RH_Oct_2023/RH/rhf1d_fchroma_50s_1broadc_7vt_EB3/run')
    ...
    filename = base2+'rhf1d_fchroma_50s_1broadc_7vt_EB3.npz'
