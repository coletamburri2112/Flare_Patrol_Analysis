...
if hbeta==1:
    ...
    yconvqs_hb = psf_adjust(model_choiceqs_wl_hbeta,model_choiceqs_int_hbeta,fwhm,dkist_wl_hbeta)
    
    yconv1_hb=psf_adjust(model1_copy_wl_hb,model1_copy_int_hb,fwhm,dkist_wl_hbeta)
...
fig,ax=plt.subplots()
ax.pcolormesh(np.transpose(dkist_choice),cmap='inferno')
ax.invert_xaxis()
ax.invert_yaxis()
fig.show()
