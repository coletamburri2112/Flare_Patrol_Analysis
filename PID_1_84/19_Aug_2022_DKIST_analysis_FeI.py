...
folder1 = 'BDNMG'
folder2 = 'AOLEW' # for QS calibration - data from 22UT on 19 August
...
sampf,sampo = DKISTanalysis.find_specsamp(line1,line2,wlsel,dispersion_range,space_and_time_averaged_qs,lowinds,highinds)
