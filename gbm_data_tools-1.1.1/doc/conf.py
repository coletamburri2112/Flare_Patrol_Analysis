...
project = 'GBM Data Tools'
#copyright = '2021, Fermi GBM'
author = 'Fermi GBM'
...
htmlhelp_basename = 'GBMDataToolsdoc'
...
latex_documents = [
    (master_doc, 'GBMDataTools.tex', 'GBM Data Tools Documentation',
     'Fermi GBM', 'manual'),
]
...
man_pages = [
    (master_doc, 'gbmdatatools', 'GBM Data Tools Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GBMDataTools', 'GBM Data Tools Documentation',
     author, 'GBMDataTools', 'One line description of project.',
     'Miscellaneous'),
]
