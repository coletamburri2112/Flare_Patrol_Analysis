...
folder1 = 'BRYZE'
folder2 = 'AORVR'  #AORVR is the QS at disk center for 11 August obs
...
startstepqs = 0
endstepqs=30
startstep=2650#where does interesting bit begin? #1800 is start of brightening?
endstep=3250#where does interesting bit end? #4800 near end of brightening?
print('here2')
